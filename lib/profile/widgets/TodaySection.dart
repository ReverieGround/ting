...
class _TodaySectionState extends State<TodaySection> {
  ...
  Widget build(BuildContext context) {
    ...
    sortedPosts.sort((a, b) {
      final aTime = a['created_at'].toDate(); // DateTime.tryParse(a['created_at'].toDate() ?? '') ?? DateTime(2000);
      final bTime = b['created_at'].toDate(); // DateTime.tryParse(b['created_at'].toDate() ?? '') ?? DateTime(2000);
